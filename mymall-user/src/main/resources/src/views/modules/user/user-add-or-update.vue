<template>
  <el-dialog
    ...
    <el-form-item label="用户手机号码" prop="userPhoneNumber">
      <el-input v-model="dataForm.userPhoneNumber" placeholder="用户手机号码"></el-input>
    </el-form-item>
    </el-form>
          ...
          if (this.dataForm.userId) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.userPhoneNumber = data.user.userPhoneNumber
              }
            })
          }
        })
