package com.chen.mymall.miaosha.service;
...
public class SeckillProductService {
    ...
    private void mqSend(String seckillId, Integer userId) {
        ...
        try {
            System.out.println("seckill_order"+"发送消息");
            //消息队列发布了用户id和商品id 实现数据库 1、写订单表 2、扣库存
    ...
    public void mqReceiver(@Payload Map map){
        System.out.println("消费者消费消息测试是否消费了——看userId");
